...
public class BottleRunner12 {
	...
	public static void main(String[] args) {
		try (Connection connection = DriverManager.getConnection(BottleConnectionData.URL.getValue(),
			...
			String querry = "UPDATE bottle_detailes set bottle_name='brocode' where bottle_name='Kingfisher'";
			...
			System.out.println("connection is not done" + e.getLocalizedMessage());
